...
lessonRouter.get('/lesson/:id', (req, res) => lessonsController.getLessonById(req, res));
lessonRouter.get('/lessons/:moduleId', (req, res) => lessonsController.getLessonsByModuleId(req, res));
