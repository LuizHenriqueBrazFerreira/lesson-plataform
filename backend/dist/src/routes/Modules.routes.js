...
moduleRouter.get('/modules/:courseId', (req, res) => modulesController.getModulesByCourseId(req, res));
moduleRouter.get('/module/:id', (req, res) => modulesController.getModuleById(req, res));
